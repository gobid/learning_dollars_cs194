...
var buf = [];
var jade_mixins = {};
var locals_ = (locals || {}),undefined = locals_.undefined,key = locals_.key,name = locals_.name,enddate = locals_.enddate,projectid = locals_.projectid;
...
buf.push("<a" + (jade.attr("href", "project/" + (key) + "", true, false)) + ">");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
...
buf.push("</button>");
jade_debug.shift();
jade_debug.unshift({ lineno: 13, filename: "jade/mybids/all_bids.jade" });
buf.push(" ");
jade_debug.shift();
jade_debug.unshift({ lineno: 14, filename: "jade/mybids/all_bids.jade" });
...
jade_debug.shift();;return buf.join("");
  ...
  jade.rethrow(err, jade_debug[0].filename, jade_debug[0].lineno, "tr\n  td\n    a(href=\"project/#{key}\")\n      |#{name}\n  td #{enddate}\n  td\n    button(\n      type=\"Submit\", \n      state=\"1\", \n      projectid=projectid, \n      class=\"btn btn-default accept_bid\"\n    ) Accept\n    | \n    button(\n      type=\"Submit\", \n      state=\"0\", \n      projectid=projectid, \n      class=\"btn btn-default decline_bid\"\n    ) Decline\n\n");
}
},
