...
buf.push("<button id=\"helpful\"" + (jade.attr("propertyname", course.Title, true, false)) + " class=\"btn btn-default btn-lg glyphicon glyphicon-thumbs-up\">");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.shift();
buf.push("</button>");
jade_debug.shift();
...
buf.push("<button id=\"nothelpful\" class=\"btn btn-default btn-lg glyphicon glyphicon-thumbs-down\">");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.shift();
buf.push("</button>");
jade_debug.shift();
...
buf.push("<a target=\"_blank\"" + (jade.attr("href", course.DownloadPageLink, true, false)) + ">");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.unshift({ lineno: 173, filename: jade_debug[0].filename });
buf.push("Course Materials");
jade_debug.shift();
jade_debug.shift();
buf.push("</a>");
...
buf.push("<button id=\"helpful\" class=\"btn btn-default btn-lg glyphicon glyphicon-thumbs-up\">");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.shift();
buf.push("</button>");
jade_debug.shift();
