...
buf.push("</div>");
jade_debug.shift();
jade_debug.unshift({ lineno: 86, filename: "jade/module/module.jade" });
...
jade_debug.unshift({ lineno: 92, filename: "jade/module/module.jade" });
jade_debug.unshift({ lineno: 93, filename: "jade/module/module.jade" });
if ( course != "")
{
jade_debug.unshift({ lineno: 94, filename: "jade/module/module.jade" });
jade_debug.unshift({ lineno: 94, filename: "jade/module/module.jade" });
if ( course.Title)
{
...
jade_debug.unshift({ lineno: 108, filename: "jade/module/module.jade" });
jade_debug.unshift({ lineno: 109, filename: "jade/module/module.jade" });
if ( course != "")
{
...
jade_debug.shift();
jade_debug.unshift({ lineno: 163, filename: "jade/module/module.jade" });
count = count + 1 
jade_debug.shift();
jade_debug.shift();
}
...
jade_debug.shift();
jade_debug.unshift({ lineno: 164, filename: "jade/module/module.jade" });
...
buf.push("<a id=\"suggestcourse\" data-toggle=\"popover\" data-content=\"\">");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.unshift({ lineno: 172, filename: jade_debug[0].filename });
buf.push("Suggest a course!");
jade_debug.shift();
jade_debug.unshift({ lineno: 173, filename: "jade/module/module.jade" });
buf.push("<div id=\"popover-head\" class=\"hide\">");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
...
buf.push("<div id=\"popover-content\" class=\"hide\">");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
...
buf.push("<input type=\"text\" placeholder=\"Course URL\" class=\"form-control\"/>");
jade_debug.shift();
jade_debug.shift();
buf.push("</div>");
jade_debug.shift();
jade_debug.unshift({ lineno: 178, filename: "jade/module/module.jade" });
buf.push("<button id=\"submitsuggestion\" class=\"btn btn-default btn-lg\">");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.unshift({ lineno: 178, filename: jade_debug[0].filename });
buf.push("Submit");
jade_debug.shift();
jade_debug.shift();
buf.push("</button>");
