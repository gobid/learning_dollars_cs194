...
var buf = [];
var jade_mixins = {};
var locals_ = (locals || {}),undefined = locals_.undefined,name = locals_.name,youtube = locals_.youtube,yt_type = locals_.yt_type,jobs = locals_.jobs,courses = locals_.courses;
...
buf.push("<button id=\"nothelpful\" class=\"btn btn-default btn-lg\">");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.unshift({ lineno: 168, filename: jade_debug[0].filename });
buf.push("This course wasn't relevant...");
jade_debug.shift();
jade_debug.shift();
buf.push("</button>");
