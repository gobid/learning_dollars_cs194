...
buf.push("<div id=\"test\">");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.unshift({ lineno: 34, filename: "jade/myposts/myposts.jade" });
buf.push("<input id=\"job_type\" data-provide=\"typeahead\" placeholder=\"Category\" class=\"form-control typeahead\"/>");
jade_debug.shift();
jade_debug.shift();
buf.push("</div>");
jade_debug.shift();
