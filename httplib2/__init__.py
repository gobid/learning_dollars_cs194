...
class DigestAuthentication(Authentication):
    ...
    def __init__(self, credentials, host, request_uri, headers, response, content, http):
        ...
        self.A1 = "".join(
            [self.credentials[0], ":", self.challenge['realm'], ":", self.credentials[1]])
        self.challenge['nc'] = 1
                ...
                if redirections:
                    ...
                    if response.has_key('location'):
                        ...
                        (response, content) = self.request(
                            location, redirect_method, body=body, headers=headers, redirections=redirections - 1)
            ...
            if cached_value and method in ["GET", "HEAD"] and self.cache and 'range' not in headers:
                if info.has_key('-x-permanent-redirect-url'):
                    ...
                    (response, new_content) = self.request(
                        info['-x-permanent-redirect-url'], "GET", headers=headers, redirections=redirections - 1)
